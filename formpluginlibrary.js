...
function pluginCartagena()
{
	document.getElementById("theForm").action = "https://docs.google.com/forms/d/e/1FAIpQLSdhE8FGuUxVZ_2-CTmf1OIcjg5MOZBxXCXeqRc47lZVl5z-rQ/formResponse";
	...
	document.getElementById("location").name = "entry.1609186721";
	// you need to manually fill in the location field here
	document.getElementById("location").value = "Cartagena";
